...
![Landing page desktop](./docs/evidence/screenshot-landing-desktop.png)

**Desktop — payment flow**

![Payment flow desktop](./docs/evidence/screenshot-payment-desktop.png)

**Mobile — payment flow**

![Payment flow mobile](./docs/evidence/screenshot-payment-mobile.png)

**Developer documentation site**

![Developer docs](./docs/evidence/screenshot-docs-desktop.png)

### On-chain transaction activity

Every payment settles atomically and transparently on Stellar Soroban.
Rather than a separate analytics dashboard, transaction history is
directly verifiable on
...
![Stellar Expert transaction example](./docs/evidence/screenshot-stellar-expert-tx.png)
...
wallet addresses and transaction hashes) is in
[`docs/evidence/user-testing.csv`](./docs/evidence/user-testing.csv).
The 50-user target has been met.
