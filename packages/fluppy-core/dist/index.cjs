...
function parseFluppyError(err) {
  ...
  if (message.includes("RPC submission") || lowerMessage.includes("network error") || lowerMessage.includes("fetch failed") || lowerMessage.includes("failed to fetch") || lowerMessage.includes("err_empty_response") || message.includes("ERR_EMPTY_RESPONSE")) {
...
function computeChainId(networkPassphrase) {
  ...
  const hashed = stellarSdk.hash(passphraseBytes);
  hashed[0] = 0;
  return BigInt(`0x${hashed.toString("hex")}`).toString();
}
...
exports.BN254_R = BN254_R;
exports.CIRCUIT_DEPTH = CIRCUIT_DEPTH;
exports.DEFAULT_MAX_AMOUNT = DEFAULT_MAX_AMOUNT;
exports.DEFAULT_MIN_AMOUNT = DEFAULT_MIN_AMOUNT;
exports.FLUPPY_CORE_VERSION = FLUPPY_CORE_VERSION;
exports.FluppyArtifactError = FluppyArtifactError;
exports.FluppyContractError = FluppyContractError;
exports.FluppyError = FluppyError;
exports.FluppyNetworkError = FluppyNetworkError;
exports.FluppyProofError = FluppyProofError;
exports.FluppyRootMismatchError = FluppyRootMismatchError;
exports.FluppyWalletError = FluppyWalletError;
exports.N_PUBLIC = N_PUBLIC;
exports.POSEIDON_TAGS = POSEIDON_TAGS;
...
exports.encodeG2 = encodeG2;
exports.hexSecretToFieldElement = hexSecretToFieldElement;
exports.parseFluppyError = parseFluppyError;
exports.usdcToStroops = usdcToStroops;
